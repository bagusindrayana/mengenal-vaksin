    ...
    @if (isset($wrongAnswer) && count($wrongAnswer) > 0)
        <div id="container-alert" class="animate__animated">
            <div class="row">
                <div class="col-md-6 mx-auto p-3 py-5">
                    <div class="bg-white rounded-pill p-3 text-center my-2">
                        <h1 class="text-danger">Yah jawabannmu ada yang salah :(</h1>
                    </div>
                </div>
            </div>
            <div class="action">
    ...
    <div class="main-content mx-auto">
        ...
        <div class="row">
            <div class="col-md-12 text-center text-primary py-3">
                <p class="fs-1 fw-bold">Quiz {!! $vaksin->nama_vaksin !!}</p>
            </div>
        </div>
        <form action="{{ route('quiz-vaksin.jawab',$vaksin->slug) }}" method="POST">
            @csrf
            <div class="row mb-3">
                <div class="col-md-12">
                    @foreach ($vaksin->Quiz()->inRandomOrder()->get() as $quiz)
            ...
            @if (!isset($wrongAnswer) && !isset($correctAnswer))
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button type="submit" class="btn btn-primary rounded-pill fs-3 px-4 py-2">Jawab</button>
                    </div>
                </div>
            @endif
